...
export default function RestaurantDetail() {
  ...
  const categoryName =
    state.categories.find((c) => String(c.id) === String(restaurant.categoryId))?.name ||
    "Unknown";
    ...
    <div>
      ...
      <Card>
        ...
        <Card.Body>
          ...
          <p>
            <strong>Category:</strong> <Badge bg="info">{categoryName}</Badge>
          </p>
          <p>
          ...
          <p>
            <strong>Price Min:</strong> {formatVND(restaurant.priceMin)}
          </p>
          <p>
            <strong>Price Max:</strong> {formatVND(restaurant.priceMax)}
          </p>
          {restaurant.openDate && (
            <p>
              <strong>Open Date:</strong>{" "}
              {formatDateDisplay(restaurant.openDate)}
            </p>
          )}
        </Card.Body>
      </Card>
